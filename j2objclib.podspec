...
Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source_files = FileList["build/j2objclib.h"].include("build/j2objcBuild/dependencies/out/main/**/*.{h,m,cpp,properites,txt}").include("build/j2objcBuild/source/out/main/**/*.{h,m,cpp,properites,txt}").to_ary
